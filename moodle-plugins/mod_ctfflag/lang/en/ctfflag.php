...
$string['xpaward_help'] = 'XP points awarded on success via Level Up XP (block_xp) when local_gamification is installed. Default 50 when left at 0.';
...
$string['flagformatinvalid'] = 'Flags must use the UT{value} format (letters, numbers, hyphens, underscores).';
$string['flagsubmitting'] = 'Checking your flag…';
$string['flagratelimited'] = 'Too many incorrect attempts. Take a short break and review the scenario before trying again.';
$string['labinstructions'] = 'Lab scenario and tasks';
$string['labworkspacehint'] = 'Read the scenario, derive your flag, then submit for instant grading.';
$string['taskpurgefailed'] = 'Purge old failed CTF lab submissions';
