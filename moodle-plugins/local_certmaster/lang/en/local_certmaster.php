...
$string['streamsettingsdesc'] = 'Signing key PEM is loaded from /etc/moodle/cf-stream-signing-key.pem (Key Vault deploy). Configure kid and customer subdomain from the Stream dashboard.';
