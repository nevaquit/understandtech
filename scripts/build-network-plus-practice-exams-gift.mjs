#!/usr/bin/env node
/**
 * Build practice-exam-{1,2,3}.gift from N10-009 banks (includes launch pool).
 *
 * Usage: node scripts/build-network-plus-practice-exams-gift.mjs [1|2|3|all]
 */
