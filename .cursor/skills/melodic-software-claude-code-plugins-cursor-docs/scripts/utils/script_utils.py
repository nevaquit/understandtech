...
# -*- coding: utf-8 -*-
"""
script_utils.py - Small shared helpers for cursor-docs scripts.
...
def normalize_url_for_display(url: str | None) -> str | None:
    ...
    Examples:
        normalize_url_for_display("https://cursor.com/docs/cli.md")
        -> "https://cursor.com/docs/cli"

        normalize_url_for_display("https://cursor.com/docs/cli.md#features")
        -> "https://cursor.com/docs/cli#features"

        normalize_url_for_display("https://cursor.com/docs/cli#features")
        -> "https://cursor.com/docs/cli#features"  (unchanged)
