...
# -*- coding: utf-8 -*-
"""
common_paths.py - Centralized path resolution utilities for cursor-docs scripts.
...
- get_skill_dir: Get cursor-docs skill root directory
...
def get_skill_dir(from_path: Path | None = None) -> Path:
    """Get the cursor-docs skill root directory.
    ...
    Example:
        >>> skill_dir = get_skill_dir()
        >>> print(skill_dir)
        /path/to/plugins/cursor-ecosystem/skills/cursor-docs
    """
...
def get_scripts_dir(from_path: Path | None = None) -> Path:
    ...
    Example:
        ...
        >>> print(scripts_dir)
        /path/to/plugins/cursor-ecosystem/skills/cursor-docs/scripts
    """
...
def get_config_dir(from_path: Path | None = None) -> Path:
    ...
    Example:
        ...
        >>> print(config_dir)
        /path/to/plugins/cursor-ecosystem/skills/cursor-docs/config
    """
    skill_dir = get_skill_dir(from_path)
