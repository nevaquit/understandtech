...
USER_AGENT = get_default('http', 'user_agent', "Cursor-Docs-Scraper/1.0 (Educational purposes)")
...
def fetch_with_retry(
    ...
    Example:
        >>> response = fetch_with_retry("https://cursor.com/docs/cli")
...
if __name__ == "__main__":
    ...
    # Test 3: is_retryable_error function
    print("\nTest 3: is_retryable_error() function")
    test_cases = [
    ...
    print("\nTest 4: get_response_with_timeout() wrapper")
    try:
