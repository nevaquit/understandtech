...
class DocResolver:
    ...
    def search_by_keyword(self, keywords: list[str], category: str | None = None,
        ...
        for doc_id in candidate_doc_ids:
            ...
            domain_key = domain
            if domain == 'cursor.com' and doc_category_for_weight:
                domain_key = f'cursor.com/{doc_category_for_weight}'
    ...
    def get_content(self, doc_id: str, section: str | None = None) -> dict[str, Any | None]:
        ...
        if MarkdownExtractor is None:
            ...
            return {
                ...
                'warning': 'Warning: Do not store file paths. Use doc_id references or invoke cursor-docs skill for access.'
            }
...
Examples:
  ...
  python doc_resolver.py cursor-com-docs-overview

  # Resolve and show metadata
  python doc_resolver.py cursor-com-docs-overview --show-metadata
""",
    )
