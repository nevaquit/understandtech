---
source_url: https://cursor.com/docs/context/codebase-indexing.md
source_type: llms-txt
content_hash: sha256:24958fd6112534d709cef6daf14671ba3d4d379cc9571b1f8c6bc76957cb4fc7
...
description: "Learn how Cursor indexes your code to provide accurate AI suggestions and enable codebase-wide search. Configure indexing settings and manage indexed projects."
};
# Codebase Indexing
...
```json
{
"path\_decryption\_key": "your-custom-key-here"
}
```
